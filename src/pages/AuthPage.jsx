...
// Injetar CSS variables do tema padrão e fonte IM Fell
const globalStyle = `
  @import url('https://fonts.googleapis.com/css2?family=IM+Fell+English:ital@0;1&family=IM+Fell+English+SC&family=Karla:wght@300;400;500&display=swap');
  :root {
    --ink: #1a1a1a; --ink-soft: #444; --ink-faint: #999;
    --paper: #ffffff; --paper-warm: #f8f8f8; --paper-dark: #eeeeee;
    --accent: #1a1a1a; --accent-light: #444; --accent-pale: #f0f0f0;
    --border: rgba(0,0,0,0.10); --border-strong: rgba(0,0,0,0.22);
  }
  * { box-sizing: border-box; margin: 0; padding: 0; }
  body { background: #ffffff; font-family: 'IM Fell English', serif; }
`;
